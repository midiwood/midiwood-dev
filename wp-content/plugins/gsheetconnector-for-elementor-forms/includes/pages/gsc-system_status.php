...
<div class="system-statuswc">
   <div class="info-container">
    <h2 class="systemifo">System Info</h2>
      ...
      <?php echo $elementorForms_gs_tools_service->get_eleforms_system_info(); ?>
   </div>
</div>
<div class="system-Error">
    <div class="error-container">
        ...
        <button onclick="copyErrorLog()" class="copy">Copy Error Log to Clipboard</button>
         <button class="clear-content-logs-elemnt">Clear</button>
        ...
        <?php echo $elementorForms_gs_tools_service->display_error_log(); ?>
    </div>
</div>
</div>
...
.clear-content-logs-elemnt:hover {
  color: #069de3;
  border-color: #069de3;
  background: #f8f9fa;;
}
